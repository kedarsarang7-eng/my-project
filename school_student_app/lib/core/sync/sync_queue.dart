...
/// Offline sync queue scaffold for school_student_app.
///
/// Per `bugfix.md` clauses 2.9, 2.10, 2.21 the student app needs a
/// durable queue with a stable `idempotencyKey` per operation so retries
/// (flaky network, forced kill, multi-device race) cannot duplicate
...
/// Lightweight queue interface. Production apps should plug in a
/// durable backend (Hive box / SharedPreferences entry) by implementing
/// this interface against a real persistent map keyed by
/// `idempotencyKey`.
