// ============================================================================
// Storage Controller — S3 Signed URL Endpoints (App Backend)
// ============================================================================
// Provides tenant-scoped file upload/download via pre-signed S3 URLs.
// Used by Customer App and Staff App for images, documents, etc.
// ============================================================================
...
router.get('/signed-url', async (req: Request, res: Response) => {
    try {
        ...
        const tenantId = (req as any).cognitoUser?.tenantId || (req as any).cognitoUser?.sub;
