  ...
  Future<void> _initTts() async {
    try {
      ...
      _flutterTts.setStartHandler(() {
        LoggerService.d('TTS', "TTS Started");
      });

      _flutterTts.setCompletionHandler(() {
        LoggerService.d('TTS', "TTS Completed");
      });

      _flutterTts.setErrorHandler((msg) {
        LoggerService.d('TTS', "TTS Error: $msg");
      });
    } catch (e) {
      LoggerService.d('TTS', "TTS Init Failed: $e");
    }
  }
  ...
  Future<void> _configureVoiceSettings() async {
    ...
    try {
      ...
      if (voices != null && voices is List) {
        ...
        // for (var v in voices) LoggerService.d('TTS', "Voice: $v");
