...
class SignatureManager {
  ...
  Future<Uint8List?> getSignature() async {
    ...
    try {
      ...
      LoggerService.d('Signature', 'Error loading signature from Firestore: $e');
    }
    ...
    try {
      ...
      LoggerService.d('Signature', 'Error loading signature from local: $e');
    }
  ...
  Future<bool> saveSignature(Uint8List signatureBytes) async {
    ...
    try {
      ...
      LoggerService.d('Signature', 'Error saving signature: $e');
      return false;
    }
  }
  ...
  Future<bool> deleteSignature() async {
    ...
    try {
      ...
      LoggerService.d('Signature', 'Error deleting signature: $e');
      return false;
    }
  }
  ...
  Future<Uint8List?> pickSignatureFromGallery() async {
    try {
      ...
      LoggerService.d('Signature', 'Error picking signature image: $e');
    }
    return null;
  }
  ...
  Future<Uint8List?> pickSignatureFromCamera() async {
    try {
      ...
      LoggerService.d('Signature', 'Error capturing signature image: $e');
    }
    return null;
  }
  ...
  Future<Uint8List?> convertDrawingToImage(
    ...
    try {
      ...
      LoggerService.d('Signature', 'Error converting drawing to image: $e');
      return null;
    }
  }
