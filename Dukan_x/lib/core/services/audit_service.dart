...
class AuditService {
  ...
  Future<void> logInvoiceCreation(Bill bill) async {
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log invoice creation: $e');
    }
  }
  ...
  Future<void> logInvoiceUpdate(Bill oldBill, Bill newBill) async {
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log invoice update: $e');
    }
  }
  ...
  Future<void> logInvoiceDeletion(
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log invoice deletion: $e');
    }
  }
  ...
  Future<void> logSecurityEvent({
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log security event: $e');
    }
  }
  ...
  Future<void> logPaymentCreation({
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log payment creation: $e');
    }
  }
  ...
  Future<void> logPaymentUpdate({
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log payment update: $e');
    }
  }
  ...
  Future<void> logPaymentVoid({
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log payment void: $e');
    }
  }
  ...
  Future<void> logPaymentDeletion({
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log payment deletion: $e');
    }
  }
  ...
  Future<void> logIrnGeneration(
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log IRN generation: $e');
    }
  }
  ...
  Future<void> logIrnCancellation({
    ...
    try {
      ...
      LoggerService.d('AuditService', 'AuditService: Failed to log IRN cancellation: $e');
    }
  }
}
