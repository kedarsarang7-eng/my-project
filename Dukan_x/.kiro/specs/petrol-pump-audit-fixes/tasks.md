...
- [-] 13. Write bug condition exploration test — Real Error Messages
...
- [~] 14. Write bug condition exploration test — No Debug Console Output
...
- [~] 15. Write bug condition exploration test — Anomaly Flagged Alongside Clamp
...
- [~] 16. Write preservation property test — Non-Petrol Business Types Unaffected
...
- [~] 17. Write preservation property test — Petrol Pump GST Defaults Preserved
...
- [~] 18. Write preservation property test — Shift-Close Reconciliation/Cash-Variance Logic Preserved
...
- [~] 19. Write preservation property test — Tank/Dispenser Validators and Audit Logging Preserved
...
- [~] 20. Write preservation property test — Existing UserRole Resolution Preserved
...
- [ ] 21. Fix Surface 1: billing.fuelSaleWiring

  - [~] 21.1 Implement the fix
  ...
  - [~] 21.2 Verify bug condition exploration test now passes
...
- [ ] 22. Fix Surface 2: datastore.splitBrain

  - [~] 22.1 Implement the fix
  ...
  - [~] 22.2 Verify bug condition exploration test now passes
...
- [ ] 23. Fix Surface 3: ui.dispenserNozzleReadingEntry

  - [~] 23.1 Implement the fix
...
- [ ] 24. Fix Surface 4: dashboard.orphaned
...
- [ ] 25. Fix Surface 5: alerts.hardcodedCounts

  - [~] 25.1 Implement the fix
  ...
  - [~] 25.2 Verify bug condition exploration test now passes
...
- [ ] 26. Fix Surface 6: report.fuelProfitHardcoded

  - [~] 26.1 Implement the fix
  ...
  - [~] 26.2 Verify bug condition exploration test now passes
...
- [ ] 27. Fix Surface 7: stock.purchasePriceDiscarded
...
- [ ] 28. Fix Surface 8: rbac.sidebarGateMissing

  - [~] 28.1 Implement the fix
  ...
  - [~] 28.2 Verify bug condition exploration test now passes
  ...
  - [~] 28.3 Verify preservation tests still pass
    - **Property 16: Preservation** - Existing UserRole Resolution Unchanged
    - Re-run task 20's test — do NOT write a new test
    - Expected outcome: test PASSES
    - _Requirements: 3.6_

- [ ] 29. Fix Surface 9: rbac.readingPermissionBypass

  - [~] 29.1 Implement the fix
  ...
  - [~] 29.2 Verify bug condition exploration test now passes
  ...
  - [~] 29.3 Verify preservation tests still pass
...
- [ ] 30. Fix Surface 10: shift.rolloverAndBilledLitres

  - [~] 30.1 Implement the fix
...
- [ ] 31. Fix Surface 11: fuelRates.fabAndBoundsMissing

  - [~] 31.1 Implement the fix
  ...
  - [~] 31.2 Verify bug condition exploration test now passes
...
- [ ] 32. Fix Surface 12: bug.mojibake
  ...
  - [~] 32.2 Verify bug condition exploration test now passes
  ...
  - [~] 32.3 Verify preservation tests still pass
    - **Property 16: Preservation** - No Behavioral Change from Comment/Text Fix
    - Re-run task 16's test — do NOT write a new test
    - Expected outcome: test PASSES
    - _Requirements: 3.1_

- [ ] 33. Fix Surface 13: bug.escapedErrorString

  - [~] 33.1 Implement the fix
  ...
  - [~] 33.2 Verify bug condition exploration test now passes
  ...
  - [~] 33.3 Verify preservation tests still pass
    - **Property 16: Preservation** - Other Dialog Error Handling Unchanged
    - Re-run task 19's test — do NOT write a new test
    - Expected outcome: test PASSES
    - _Requirements: 3.4_

- [ ] 34. Fix Surface 14: bug.debugPrints

  - [~] 34.1 Implement the fix
  ...
  - [~] 34.2 Verify bug condition exploration test now passes
  ...
  - [~] 34.3 Verify preservation tests still pass
    - **Property 16: Preservation** - Transactional/Error-Path Behavior Unchanged
    - Re-run task 19's test — do NOT write a new test
    - Expected outcome: test PASSES
    - _Requirements: 3.5_

- [ ] 35. Fix Surface 15: validation.silentClampNoFlag

  - [~] 35.1 Implement the fix
  ...
  - [~] 35.2 Verify bug condition exploration test now passes
  ...
  - [~] 35.3 Verify preservation tests still pass
