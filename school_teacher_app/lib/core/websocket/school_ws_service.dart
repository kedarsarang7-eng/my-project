...
/// Real-time WebSocket service for teacher app.
/// Receives attendance confirmations, leave approvals, and announcements.
...
class _NotifNotifier extends StateNotifier<List<WsEvent>> {
  ...
  _NotifNotifier(SchoolWsService ws) : super([]) {
    _sub = ws.events.listen((e) => state = [e, ...state.take(49)]);
  }
  void clear() => state = [];
  @override
