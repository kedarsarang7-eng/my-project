...
class _State extends ConsumerState<LeaveScreen>
    ...
    return PageScaffold(
      ...
      body: Column(children: [
        ...
        Expanded(
            child: TabBarView(
                controller: _tabs,
                children: [_MyLeaves(ref: ref), _PendingApprovals(ref: ref)])),
      ]),
    );
  }
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                          ...
                          items: ['casual', 'sick', 'earned', 'emergency']
