          ...
          data: (plans) => plans.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final subject =
                        plan['subject'] ?? plan['subjectName'] ?? 'Subject';
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              if (plan['learningObjectives'] != null) ...[
                                const SizedBox(height: 8),
                                Text(plan['learningObjectives'].toString(),
                                    style: const TextStyle(
                                        color: AppTheme.textSecondary,
                                        fontSize: 12),
                                    maxLines: 2,
                              ...
                              : () async {
                                  ...
                                  try {
                                    await ref
                                      ...
                                      if (date != null)
                                        'plannedDate': DateFormat('yyyy-MM-dd')
                                            .format(date!),
                                    });
                                    ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(
                                            content:
                                                Text('Lesson plan created!'),
