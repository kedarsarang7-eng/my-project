              ...
              child: Column(
                  children: List.generate(
                      ...
                      (_) => Padding(
                          ...
                          child: const ShimmerBox(height: 68))))),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final icons = {
                      ...
                      'practicePaper': Icons.quiz_outlined,
                      'videoLink': Icons.play_circle_outline,
                      'reference': Icons.book_outlined
                    };
                    final colors = {
                      'notes': AppTheme.primary,
                      'practicePaper': AppTheme.warning,
                      'videoLink': AppTheme.error,
                      'reference': AppTheme.success
                    };
                              ...
                              child: Column(
                                ...
                                Text(title,
                                    style: const TextStyle(
                                        ...
                                        fontSize: 13)),
                                Text(
                                    '${type}${batch.isNotEmpty ? " · $batch" : ""} · $views downloads',
                                    style: const TextStyle(
