// ============================================================================
// UNS providers — school_admin_app
// ----------------------------------------------------------------------------
...
/// Single canonical SDK instance per signed-in session.
final notificationsSdkProvider =
    FutureProvider<NotificationsSdk>((ref) async {
...
/// Thin HTTP client backing the bell / drawer / preferences page.
