      ...
      body: Column(children: [
        ...
        Expanded(
          ...
          future: ref
              ...
              .getFaculty(search: _search.isNotEmpty ? _search : null),
          builder: (_, snap) {
            ...
            final faculty =
                (snap.data?['items'] ?? snap.data?['faculty'] ?? []) as List;
            if (faculty.isEmpty)
              return const EmptyState(
                  message: 'No faculty found', icon: Icons.badge_outlined);
                    ...
                    child: Row(children: [
                      ...
                      Expanded(
                          child: Column(
                            ...
                            Text(
                                '$designation${dept.isNotEmpty ? " · $dept" : ""}',
                                style: const TextStyle(
                      ...
                      StatusBadge(
                          label: empType == 'full_time' ? 'FT' : 'PT',
                          color: empType == 'full_time'
                              ? AppTheme.success
                              : AppTheme.warning),
                    ]),
                  ),
