...
class AuthConfig {
  static const String userPoolId =
      'YOUR_USER_POOL_ID'; // To be replaced via env or config
  static const String clientId =
      'YOUR_APP_CLIENT_ID'; // To be replaced via env or config
}
...
class CognitoAuthService {
  ...
  Future<CognitoUserSession?> login(String username, String password) async {
    ...
    try {
      ...
      // Handle admin-created accounts requiring new password
...
@riverpod
CognitoAuthService authService(Ref ref) {
